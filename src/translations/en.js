...
blockTimeSlot: {
  ...
  blockNewSlot: 'Block New Time Slot',
  existingBlocks: 'Existing Blocked Slots',
  selectDate: 'Select Date',
  startTime: 'Start Time',
  endTime: 'End Time',
  reason: 'Reason',
  optional: 'optional',
  reasonPlaceholder: 'Enter reason for blocking this time slot...',
  blockSlot: 'Block Time Slot',
  blocking: 'Blocking...',
  unblock: 'Remove Block',
  noBlockedSlots: 'No blocked time slots',
  fillAllFields: 'Please fill in all required fields',
  invalidTimeRange: 'End time must be after start time',
  slotBlocked: 'Time slot blocked successfully',
  slotUnblocked: 'Time slot unblocked successfully',
  errorBlocking: 'Error blocking time slot',
  errorDeleting: 'Error removing blocked time slot',
  errorFetchingSlots: 'Error loading blocked time slots',
  confirmDelete: 'Are you sure you want to remove this blocked time slot?',
  selectStaff: 'Select Staff Member',
  selectStaffPlaceholder: 'Choose a staff member to block time for',
  loadingStaff: 'Loading staff members...',
  selectStaffError: 'Please select a staff member to block time for.'
},
  // Language switcher
  language: {
    english: 'English',
  ...
  settings: {
    ...
    maxBookingNumber: 'Maximum Booking Number',
    maxBookingNumberDesc: 'Maximum number of people allowed per booking slot',
    minutes5: '5 minutes',
  ...
  messages: {
    ...
    error: {
      ...
      maxNumberValidation: 'This field is required. Max number must be a positive number and smaller than {maxValue}',
